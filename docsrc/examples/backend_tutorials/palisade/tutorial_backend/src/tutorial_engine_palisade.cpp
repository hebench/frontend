...
BaseEngine *createEngine()
{
    ...
    // our backend by checking against the constants defined in `hebench/api_bridge/version_palisade.h`
...
void TutorialEngine::init()
{
    ...
    addErrorCode(TUTORIAL_ECODE_PALISADE_ERROR, "PALISADE error.");
    //! [engine init error codes]
