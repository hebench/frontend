Quickstart C++ Wrapper Backend Tutorial - Engine Initialization and Benchmark Description {#be_tutorial_init_seal}
========================
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor init
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor workload
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor data_type
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor category
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor category_params
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor op_params_mask
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor scheme
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor security
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor other
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor workload_params
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc constructor
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc create

This is the destroy method:

\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc destroy
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_eltwiseadd_benchmark_seal.cpp b_desc print
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_engine_seal.cpp engine init error codes
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_engine_seal.cpp engine init schemes
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_engine_seal.cpp engine init security
...
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_engine_seal.cpp engine init benchmarks
    
The full code for our engine init function looks like this:
\snippet{lineno} docsrc/examples/backend_tutorials/seal/tutorial_backend/src/tutorial_engine_seal.cpp engine init
