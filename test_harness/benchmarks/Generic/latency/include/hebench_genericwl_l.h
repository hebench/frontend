...
#ifndef _HEBench_Harness_GenericWL_L_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_GenericWL_L_H_0596d40a3cce4b108a81595c50eb286d
...
private:
    IL_DECLARE_CLASS_NAME(GenericWL::Latency::BenchmarkDescriptor)
public:
    static constexpr std::uint32_t BenchmarkID      = 1001;
...
private:
    IL_DECLARE_CLASS_NAME(GenericWL::Latency::Benchmark)

public:
    friend class hebench::TestHarness::GenericWL::Latency::BenchmarkDescriptor;
