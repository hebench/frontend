...
class BenchmarkDescriptor final : public hebench::TestHarness::EltwiseMult::BenchmarkDescriptorCategory
{
public:
    DISABLE_COPY(BenchmarkDescriptor)
    DISABLE_MOVE(BenchmarkDescriptor)
private:
    IL_DECLARE_CLASS_NAME(EltwiseMult::Latency::BenchmarkDescriptor)
public:
...
public:
    friend class hebench::TestHarness::EltwiseMult::Latency::BenchmarkDescriptor;
