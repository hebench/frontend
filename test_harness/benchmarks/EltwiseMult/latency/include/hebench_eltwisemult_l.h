...
#ifndef _HEBench_Harness_EltwiseMult_L_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_EltwiseMult_L_H_0596d40a3cce4b108a81595c50eb286d
...
#include "benchmarks/EltwiseMult/include/hebench_eltwisemult.h"
...
class BenchmarkDescription final : public hebench::TestHarness::EltwiseMult::BenchmarkDescriptionCategory
{
public:
    DISABLE_COPY(BenchmarkDescription)
    DISABLE_MOVE(BenchmarkDescription)
private:
    IL_DECLARE_CLASS_NAME(EltwiseMult::Latency::BenchmarkDescription)
public:
    static constexpr std::uint32_t BenchmarkID      = 501;
...
class Benchmark : public hebench::TestHarness::BenchmarkLatency
{
public:
    DISABLE_COPY(Benchmark)
    DISABLE_MOVE(Benchmark)
private:
    IL_DECLARE_CLASS_NAME(EltwiseMult::Latency::Benchmark)

public:
    friend class hebench::TestHarness::EltwiseMult::Latency::BenchmarkDescription;
...
#endif // defined _HEBench_Harness_EltwiseMult_L_H_0596d40a3cce4b108a81595c50eb286d
