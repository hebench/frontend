...
#ifndef _HEBench_Harness_DataGenerator_EltwiseMult_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_DataGenerator_EltwiseMult_H_0596d40a3cce4b108a81595c50eb286d
...
private:
    IL_DECLARE_CLASS_NAME(EltwiseMult::DataLoader)
...
public:
    ...
    static DataLoader::Ptr create(std::uint64_t expected_vector_size,
...
private:
    ...
    void init(std::uint64_t vector_size,
              ...
              std::uint64_t batch_size_b,
              hebench::APIBridge::DataType data_type);
    void init(std::uint64_t expected_vector_size,
              std::uint64_t max_batch_size_a,
              std::uint64_t max_batch_size_b,
              hebench::APIBridge::DataType data_type,
              const std::string &dataset_filename);
...
#endif // defined _HEBench_Harness_DataGenerator_EltwiseMult_H_0596d40a3cce4b108a81595c50eb286d
