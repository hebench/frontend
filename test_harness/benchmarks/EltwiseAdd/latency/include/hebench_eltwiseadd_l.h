...
#ifndef _HEBench_Harness_EltwiseAdd_L_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_EltwiseAdd_L_H_0596d40a3cce4b108a81595c50eb286d
...
#include "benchmarks/EltwiseAdd/include/hebench_eltwiseadd.h"
...
class BenchmarkDescription final : public hebench::TestHarness::EltwiseAdd::BenchmarkDescriptionCategory
{
public:
    DISABLE_COPY(BenchmarkDescription)
    DISABLE_MOVE(BenchmarkDescription)
private:
    IL_DECLARE_CLASS_NAME(EltwiseAdd::Latency::BenchmarkDescription)
public:
...
private:
    IL_DECLARE_CLASS_NAME(EltwiseAdd::Latency::Benchmark)

public:
    friend class hebench::TestHarness::EltwiseAdd::Latency::BenchmarkDescription;
...
#endif // defined _HEBench_Harness_EltwiseAdd_L_H_0596d40a3cce4b108a81595c50eb286d
