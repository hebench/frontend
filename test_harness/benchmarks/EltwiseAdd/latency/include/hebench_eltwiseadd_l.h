...
class BenchmarkDescriptor final : public hebench::TestHarness::EltwiseAdd::BenchmarkDescriptorCategory
{
public:
    DISABLE_COPY(BenchmarkDescriptor)
    DISABLE_MOVE(BenchmarkDescriptor)
private:
    IL_DECLARE_CLASS_NAME(EltwiseAdd::Latency::BenchmarkDescriptor)
public:
...
public:
    friend class hebench::TestHarness::EltwiseAdd::Latency::BenchmarkDescriptor;
