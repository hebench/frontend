...
#ifndef _HEBench_Harness_EltwiseAdd_O_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_EltwiseAdd_O_H_0596d40a3cce4b108a81595c50eb286d
...
private:
    IL_DECLARE_CLASS_NAME(EltwiseAdd::Offline::BenchmarkDescription)
public:
...
private:
    IL_DECLARE_CLASS_NAME(EltwiseAdd::Offline::Benchmark)

public:
    friend class hebench::TestHarness::EltwiseAdd::Offline::BenchmarkDescription;
