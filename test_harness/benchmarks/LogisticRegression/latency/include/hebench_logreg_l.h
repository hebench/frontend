...
#ifndef _HEBench_Harness_LogisticRegression_L_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_LogisticRegression_L_H_0596d40a3cce4b108a81595c50eb286d
...
class BenchmarkDescription final : public hebench::TestHarness::LogisticRegression::BenchmarkDescriptionCategory
{
public:
    DISABLE_COPY(BenchmarkDescription)
    DISABLE_MOVE(BenchmarkDescription)
private:
    IL_DECLARE_CLASS_NAME(LogisticRegression::Latency::BenchmarkDescription)
public:
    static constexpr std::uint32_t BenchmarkID      = 801;
...
private:
    IL_DECLARE_CLASS_NAME(LogisticRegression::Latency::Benchmark)

public:
    friend class hebench::TestHarness::LogisticRegression::Latency::BenchmarkDescription;
...
#endif // defined _HEBench_Harness_LogisticRegression_L_H_0596d40a3cce4b108a81595c50eb286d
