...
class BenchmarkDescriptor final : public hebench::TestHarness::LogisticRegression::BenchmarkDescriptorCategory
{
public:
    DISABLE_COPY(BenchmarkDescriptor)
    DISABLE_MOVE(BenchmarkDescriptor)
private:
    IL_DECLARE_CLASS_NAME(LogisticRegression::Latency::BenchmarkDescriptor)
public:
...
public:
    friend class hebench::TestHarness::LogisticRegression::Latency::BenchmarkDescriptor;
