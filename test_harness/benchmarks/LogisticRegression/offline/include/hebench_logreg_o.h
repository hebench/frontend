...
#ifndef _HEBench_Harness_LogisticRegression_O_H_0596d40a3cce4b108a81595c50eb286d
#define _HEBench_Harness_LogisticRegression_O_H_0596d40a3cce4b108a81595c50eb286d
...
private:
    IL_DECLARE_CLASS_NAME(LogisticRegression::Offline::BenchmarkDescription)
public:
...
private:
    IL_DECLARE_CLASS_NAME(LogisticRegression::Offline::Benchmark)

public:
    friend class hebench::TestHarness::LogisticRegression::Offline::BenchmarkDescription;
...
#endif // defined _HEBench_Harness_LogisticRegression_O_H_0596d40a3cce4b108a81595c50eb286d
